<%@page import="PresentationLayer.Forum.GetBoard"%>
...
<%--
This doesn't work. I haven't been able to figure out why.
<c:if test="${requestScope.board == null}">
    <jsp:forward page="/FrontController">
        <jsp:param name="target" value="getBoard"/>
        <jsp:param name="boardId" value="${requestScope.boardId != null ? requestScope.boardId : param.boardId}"/>
    </jsp:forward>
</c:if>
--%>
