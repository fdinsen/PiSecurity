...
<c:if test='${requestScope.threadId == null && param.threadId == null}'>
...
<div class="container">
    <div class="col-lg text-center" style="">
        <h1 class="display-1">Create new Post</h1>
    </div>
    <div class="row align-items-center">
        ...
        <div class="col-sm" style="">
            <div class="card mt-4" style="width: 45rem;">
                <div class="card-body">
                    <form name="newPost" action="FrontController" method="post">
                        <input type="hidden" name="target" value="createPost">
                        <input type="hidden" name="threadId" value="${requestScope.threadId != null ? requestScope.threadId : param.threadId}">
